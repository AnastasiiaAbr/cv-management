...
-- AddForeignKey
ALTER TABLE "CVAttributeValue" ADD CONSTRAINT "CVAttributeValue_attributeId_fkey" FOREIGN KEY ("attributeId") REFERENCES "Attribute"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
